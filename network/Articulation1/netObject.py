...
class netObject:
    ...
    def syncNetObject(self):
        ...
        try:
            ...
            self.angularVelocity = self.getListThree(self.gameObject.angularVelocity) #corrigido de "setlf.angularVelocity"
        except:
            self.linearVelocity = [0,0,0]
            self.angularVelocity = [0,0,0]
        for prop in self.gameObject.getPropertyNames():
